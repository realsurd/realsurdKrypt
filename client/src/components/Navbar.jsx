...
//State to consider whether the mobile navigation is open or not {check togglemenu below}

const Navbar = () => {
  const [togglemenu, setToggleMenu ] = useState(false);   // continuation on line 37
